...
void TestTransformPart1(CuTest *tc) {  
	string file_position = "/home/kk/cutest-1.5/test/test1.cpp";
	string actual = TransformFileToString(file_position);
	const char* actual1=actual.c_str();
	string expect = "#include<iostream> using namespace std; int main() { return 0; } ";
	const char* expect1=expect.c_str();
        CuAssertStrEquals(tc, expect1, actual1);
}
void TestTransformPart2(CuTest *tc) {  
	string file_position = "/home/kk/cutest-1.5/test/test2.cpp";
	string actual = TransformFileToString(file_position);
	const char* actual1=actual.c_str();
	string expect = "#include<stdio.h> int main() { int a = 400,b = 22,c,d; char ch = \"case\"; if(a%4==0) { if(a%100!=0) { switch(b) { case 1:ch=\"switch\";break; case 2:d=31+c;break; case 3:d=31+29+c;break; case 5:d=91+30+c;break; case 6:d=121+31+c;break; /*case 8:d=182+31+c;break; case 9:d=213+31+c;break; case 10:d=244+30+c;break; case 11:d=274+31+c;break; case 12:d=305+30+c;break;*/ case 15: ch = \"if\" ; } } } return 0; } ";
	const char* expect1=expect.c_str();
      	CuAssertStrEquals(tc, expect1, actual1);
}
void TestHandleSignsPart1(CuTest *tc) {  
	string string_in_file = "/home/kk/cutest-1.5/test/test1.cpp";
	string actual = HandleSigns( string_in_file);
	const char* actual1=actual.c_str();
	string expect = " home kk cutest 1 5 test test1 cpp";
	const char* expect1=expect.c_str();
	CuAssertStrEquals(tc, expect1, actual1);
}   
void TestHandleSignsPart2(CuTest *tc) {  
	string string_in_file = "#include<stdio.h> int main() { int a = 400,b = 22,c,d; char ch = \"case\"; if(a%4==0) { if(a%100!=0) { switch(b) { case 1:ch=\"switch\";break; case 2:d=31+c;break; case 3:d=31+29+c;break; case 5:d=91+30+c;break; case 6:d=121+31+c;break; /*case 8:d=182+31+c;break; case 9:d=213+31+c;break; case 10:d=244+30+c;break; case 11:d=274+31+c;break; case 12:d=305+30+c;break;*/ case 15: ch = \"if\" ; } } } return 0; } ";
	string actual = HandleSigns( string_in_file);
	const char* actual1=actual.c_str();
	string expect = " include stdio h  int main    {  int a   400 b   22 c d  char ch    if a 4  0   {  if a 100  0   {  switch b   {  case 1 ch break  case 2 d 31 c break  case 3 d 31 29 c break  case 5 d 91 30 c break  case 6 d 121 31 c break    case 15  ch      }   }   }  return 0   }  ";
	const char* expect1=expect.c_str();
      	CuAssertStrEquals(tc, expect1, actual1);
}
void TestBranchPart1(CuTest *tc) { 
	string temp = "if";
	stringstream ss (" else ");
	int if_num=3;
	int else_num=2;
	stack<string> if_else_stack;
	if_else_stack.push("if");
	if_else_stack.push("if");
	int if_else_num=2;
	int if_elseif_else_num = 0;
	int a =BranchPart(temp, ss, if_num, else_num, if_else_stack, if_else_num, if_elseif_else_num);
		
	stringstream expected_ss (" else ");
	int expected_if_num = 4;
	int expected_else_num = 2;
	int expected_if_else_num= 2;
	int expected_if_elseif_else_num = 0;
	
     	CuAssertIntEquals(tc, expected_if_num, if_num);
	CuAssertIntEquals(tc, expected_else_num, else_num);
	CuAssertIntEquals(tc, expected_if_else_num, if_else_num);
	CuAssertIntEquals(tc, expected_if_elseif_else_num, if_elseif_else_num);  
}
    
void TestBranchPart2(CuTest *tc) {  
	string temp = "else";
	stringstream ss (" if ");
	int if_num=2;
	int else_num=0;
	...
	int expected_if_num = 3;
	int expected_else_num = 1;
	int expected_if_else_num= 0;
	int expected_if_elseif_else_num = 0;
...
void TestBranchPart3(CuTest *tc) { 
	string temp = "{";
	stringstream ss (" switch ");
	int if_num=2;
	int else_num=0;
	stack<string> if_else_stack;
	int if_else_num= 0;
	...
	stringstream expected_ss (" ");
	int expected_if_num = 2;
	int expected_else_num = 0;
	int expected_if_else_num= 0;
	int expected_if_elseif_else_num = 0;
...
void TestBranchPart4(CuTest *tc) {  
	string temp = "case";
	stringstream ss (" default ");
	int if_num=5;
	int else_num = 2;
	stack<string> if_else_stack;
	int if_else_num= 0;
	int if_elseif_else_num = 1;
	int a =BranchPart(temp, ss, if_num, else_num, if_else_stack, if_else_num, if_elseif_else_num);
		
	stringstream expected_ss (" default ");
	int expected_if_num = 5;
	int expected_else_num = 2;
	int expected_if_else_num= 0;
	int expected_if_elseif_else_num = 1;
...
void TestSwitchPart1(CuTest *tc) {  
	string temp = "switch";
	int switch_num = 0;   
	int case_num = 2;
	vector<int> case_array = {1,1};
	bool switch_num_change = 0;
		
	int expected_switch_num = 1;   
	int expected_case_num = 2;
	bool expected_switch_num_change = 1;
	int a = SwitchPart(temp, switch_num, case_num, case_array, switch_num_change);
		
      	CuAssertIntEquals(tc, expected_switch_num, switch_num);
	CuAssertIntEquals(tc, expected_case_num, case_num);
	CuAssertIntEquals(tc, expected_switch_num_change, switch_num_change);  
}
void TestSwitchPart2(CuTest *tc) {  
	string temp = "case";
	int switch_num = 1;   
	int case_num = 0;
	...
	int expected_switch_num = 1;   
	int expected_case_num = 1;
	bool expected_switch_num_change = 0;
	int a = SwitchPart(temp, switch_num, case_num, case_array, switch_num_change);
...
void TestSwitchPart3(CuTest *tc) {  
	string temp = "if";
	int switch_num = 2;   
	int case_num = 3;
	vector<int> case_array = {1,2};
	bool switch_num_change = 1;
	
	int expected_switch_num = 2;   
	int expected_case_num = 3;
	bool expected_switch_num_change = 1;
	int a = SwitchPart(temp, switch_num, case_num, case_array, switch_num_change);
...
CuSuite* TransformGetSuite() {//////////////
        ...
        SUITE_ADD_TEST(suite, TestTransformPart1);
        SUITE_ADD_TEST(suite, TestTransformPart2);
...
CuSuite* HandleSignsGetSuite() {//////////////
        ...
        SUITE_ADD_TEST(suite, TestHandleSignsPart1);
        SUITE_ADD_TEST(suite, TestHandleSignsPart2);
        return suite;
...
CuSuite* BranchGetSuite() {//////////////
        ...
        SUITE_ADD_TEST(suite, TestBranchPart1);
        SUITE_ADD_TEST(suite, TestBranchPart2);
   	SUITE_ADD_TEST(suite, TestBranchPart3);
	SUITE_ADD_TEST(suite, TestBranchPart4);
        return suite;
...
CuSuite* SwitchGetSuite() {//////////////
        ...
        SUITE_ADD_TEST(suite, TestSwitchPart1);
        SUITE_ADD_TEST(suite, TestSwitchPart2);
   	SUITE_ADD_TEST(suite, TestSwitchPart2);
