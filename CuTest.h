...
int BranchPart(string temp, stringstream& ss, int& if_num, int& else_num, stack<string>& if_else_stack, int& if_else_num, int& if_elseif_else_num);
int SwitchPart(string temp, int &switch_num, int & case_num,std::vector<int> & case_array,bool & switch_num_change);
